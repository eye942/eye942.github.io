...
/* package GitPages-0.1.0.0 */
#ifndef VERSION_GitPages
#define VERSION_GitPages "0.1.0.0"
#endif /* VERSION_GitPages */
#ifndef MIN_VERSION_GitPages
#define MIN_VERSION_GitPages(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GitPages */
...
/* package hakyll-4.12.4.0 */
#ifndef VERSION_hakyll
#define VERSION_hakyll "4.12.4.0"
...
#define CURRENT_COMPONENT_ID "GitPages-0.1.0.0-C1IFOJPqfYlKzZiwCdHk2L-site"
